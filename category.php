...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (!isset($_GET['id']) || empty($_GET['id'])) {
        ...
        $id = $_GET['id'];
        $q = "select product.id, product.category, product.productname, product.description, product.image, product.number, product.price, product.discount, category.category from category INNER JOIN product on 

        category.id = product.category where category.id = $id";
